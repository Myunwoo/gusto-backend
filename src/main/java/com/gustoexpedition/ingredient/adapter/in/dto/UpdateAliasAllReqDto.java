...
public class UpdateAliasAllReqDto {
    ...
    @NotNull(message = "ALAIS001")
    @Schema(description = "재료 별칭 목록 (기존 재료 별칭은 삭제되고 이 목록으로 교체됩니다. 빈 배열도 허용됩니다)", example = "[\"방울토마토\", \"체리토마토\"]", requiredMode = Schema.RequiredMode.REQUIRED)
