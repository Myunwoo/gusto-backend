 ...
 * fileName : UpdateEvidenceReqDto
 * author : fddsg
 * date : 2026-01-16
 * description : 재료 간 관계 증거 수정 요청 DTO
 */
@Getter
@Setter
@Schema(description = "재료 간 관계 증거 수정 요청")
public class UpdateEvidenceReqDto {

  @NotNull(message = "EVIDENCE004")
  @Min(value = 1, message = "EVIDENCE004")
  @Schema(description = "증거 ID", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
